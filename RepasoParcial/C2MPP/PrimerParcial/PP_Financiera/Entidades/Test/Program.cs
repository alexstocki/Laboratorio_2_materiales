...
using Entidades.EntidadFinanciera;
...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrestamoDolar pd1 = new PrestamoDolar(1500, new DateTime(2019, 11, 01), PeriodicidadDePagos.Mensual);
            ...
            PrestamoPesos pp1 = new PrestamoPesos(8000, new DateTime(2018, 10, 02), 20);
            ...
            pd1.ExtenderPlazo(new DateTime(2020, 12, 01));
            pp1.ExtenderPlazo(new DateTime(2018, 10, 05));
